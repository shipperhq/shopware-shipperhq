...
class RefreshShippingMethodsUseCase
{
    ...
    /**
     * @return array The allowed methods from ShipperHQ
    ...
    public function execute(): array
    {
        try {
            ...
            throw ShipperHQException::refreshFailed($e);
        }
    }

    private function doExecute(): array
    {
        ...
        // 4. Deactivate shipping methods that are no longer returned by ShipperHQ
